   ...
   <motion.div
    ...
    >
      ...
      <motion.span
        ...
        className={`text-neutral-700  text-m dark:group-hover:text-blue-400 group-hover/sidebar:translate-x-1 transition duration-150 whitespace-pre inline-block !p-0 !m-0 ${selectedPage === link.label ? "dark:text-blue-400" : "dark:text-neutral-200"}`}
      >
        {link.label}
      </motion.span>
    </Link>
